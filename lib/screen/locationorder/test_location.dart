...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  setUpMarker() async {
    const currentLocationCamera = LatLng(24.7136, 46.6753);
    ...
    final pickupMarker = Marker(
      ...
      icon: BitmapDescriptor.fromBytes(
          await getBytesFromAsset('asset/images/ic_car_top_view.png', 70)),
    );
  ...
  animateCar(
    ...
    var carMarker = Marker(
        ...
        icon: BitmapDescriptor.fromBytes(
            await getBytesFromAsset('asset/images/ic_car_top_view.png', 60)),
    ...
    _animation = tween.animate(animationController)
      ..addListener(() async {
        ...
        carMarker = Marker(
            ...
            position: newPos,
            icon: BitmapDescriptor.fromBytes(
                await getBytesFromAsset('asset/images/ic_car_top_view.png', 50)),
            anchor: const Offset(0.5, 0.5),
            flat: true,
            rotation: bearing,
            draggable: false);
