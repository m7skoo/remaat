...
class StatsScreenQR extends StatefulWidget {
  final String resultQR;
  const StatsScreenQR({Key? key, required this.resultQR}) : super(key: key);

  @override
  State<StatsScreenQR> createState() => _StatsScreenQRState();
}

class _StatsScreenQRState extends State<StatsScreenQR> {
